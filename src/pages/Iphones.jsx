...
import ip13 from '../assets/iphone 13.webp'
    ...
    <div className="px-32 py-9 flex items-center flex-wrap gap-5 max-w-screen-2xl mx-auto">
      {
        iphones && iphones.map((el, index) => {
          return (
            <div key={index} onClick={() => handleAbout(el.id)} className="transition rounded-lg w-[300px] cursor-pointer shadow-md hover:shadow-xl pb-2">
